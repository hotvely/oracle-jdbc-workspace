...
INSERT INTO VW_JOINEMP VALUES (400,'바보','노는부서');        -- ERROR
INSERT INTO VW_JOINEMP(EMP_ID, EMP_NAME) VALUES(300,'조세오테스트!');         -- SUCCESS (EMPLOYEE쪽에 넣긴함..이게왜..????)
UPDATE VW_JOINEMP SET EMP_NAME = '바보테스트' WHERE EMP_ID = 200;             -- SUCCESS
UPDATE VW_JOINEMP SET DEPT_TITLE = '회계부' WHERE EMP_ID = 200;              -- ERROR
UPDATE VW_JOINEMP SET DEPT_TITLE = '회계부' WHERE DEPT_TITLE = '총무부';      -- ERROR
DELETE FROM VW_JOINEMP WHERE EMP_ID = 200;                                  -- SUCCESS
DELETE FROM VW_JOINEMP WHERE DEPT_TITLE = '총무부';                          -- SUCCESS;...;;;;;;??????
